...
// 	<a href="https://nyassembly.gov/mem/Aravella-Simotas">36</a>,
// 	<a href="https://nyassembly.gov/mem/Catherine-Nolan">37</a>,
// 	<a href="https://nyassembly.gov/mem/Jeffrion-L-Aubry">35</a>,
// 	<a href="https://nyassembly.gov/mem/Michael-G-DenDekker">34</a>,
// 	<a href="https://nyassembly.gov/mem/Catalina-Cruz">39</a>,
// 	<a href="https://nyassembly.gov/mem/Brian-Barnwell">30</a>,
// 	<a href="https://nyassembly.gov/mem/Andrew-Hevesi">28</a>,
// 	<a href="https://nyassembly.gov/mem/Michael-Miller">38</a>,
// 	<a href="https://nyassembly.gov/mem/Stacey-Pheffer-Amato">23</a>,
// 	<a href="https://nyassembly.gov/mem/David-I-Weprin">24</a>,
// 	<a href="https://nyassembly.gov/mem/Daniel-Rosenthal">27</a>,
// 	<a href="https://nyassembly.gov/mem/Nily-Rozic">25</a>,
// 	<a href="https://nyassembly.gov/mem/Ron-Kim">40</a>,
// 	<a href="https://nyassembly.gov/mem/Edward-C-Braunstein">26</a>,
// 	<a href="https://nyassembly.gov/mem/Clyde-Vanel">33</a>,
// 	<a href="https://nyassembly.gov/mem/Alicia-Hyndman">29</a>,
// 	<a href="https://nyassembly.gov/mem/Vivian-E-Cook">32</a>,
// 	<a href="https://nyassembly.gov/mem/Michele-R-Titus">31</a>,
// ];

function getWebsite(AssemDist) {
    return AssemDist === 36	? 'https://nyassembly.gov/mem/Aravella-Simotas' :
           AssemDist === 37	? 'https://nyassembly.gov/mem/Catherine-Nolan' :
           AssemDist === 35	? 'https://nyassembly.gov/mem/Jeffrion-L-Aubry' :
           AssemDist === 34	? 'https://nyassembly.gov/mem/Michael-G-DenDekker' :
					 AssemDist === 39	? 'https://nyassembly.gov/mem/Catalina-Cruz' :
					 AssemDist === 30	? 'https://nyassembly.gov/mem/Brian-Barnwell' :
					 AssemDist === 28	? 'https://nyassembly.gov/mem/Andrew-Hevesi' :
					 AssemDist === 38	? 'https://nyassembly.gov/mem/Michael-Miller' :
					 AssemDist === 23	? 'https://nyassembly.gov/mem/Stacey-Pheffer-Amato' :
					 AssemDist === 24	? 'https://nyassembly.gov/mem/David-I-Weprin' :
					 AssemDist === 27	? 'https://nyassembly.gov/mem/Daniel-Rosenthal' :
					 AssemDist === 25	? 'https://nyassembly.gov/mem/Nily-Rozic' :
					 AssemDist === 40	? 'https://nyassembly.gov/mem/Ron-Kim' :
					 AssemDist === 26	? 'https://nyassembly.gov/mem/Edward-C-Braunstein' :
					 AssemDist === 33	? 'https://nyassembly.gov/mem/Clyde-Vanel' :
					 AssemDist === 29	? 'https://nyassembly.gov/mem/Alicia-Hyndman' :
					 AssemDist === 32	? 'https://nyassembly.gov/mem/Vivian-E-Cook' :
					 AssemDist === 31	? 'https://nyassembly.gov/mem/Michele-R-Titus' :
    													' ';
}
